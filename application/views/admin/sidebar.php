    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="#" class=""><span> Instruments </span> <span class="menu-arrow"></span></a>
                    <ul class="list-unstyled" style="display: none;">

                        <li><a href="<?php echo base_url('instruments'); ?>">Instruments</a></li>
                        <li><a href="<?php echo base_url('instruments/lists'); ?>">Instruments List</a></li>
