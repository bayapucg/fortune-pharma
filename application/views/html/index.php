                ...
                <div class="row section-body">
                    ...
                    <div class="col-lg-12 col-md-12 box wow bounceInUp" data-wow-duration="1.4s">
                        ...
                        <ul>
                            ...
                            <li>Analysis of Intermediates</li>
                            <li>Analysis of Active Pharma Ingredients</li>
                    ...
                    <div class="col-lg-12 col-md-12 box wow bounceInUp" data-wow-duration="1.4s">
                        ...
                        <ul>
                            <li>Impurities Study By HPLC & GC</li>
                            <li>Assay by HPLC & UV Spectrophotometer</li>
                            <li>ResiduaL SoLvents I Organic VoLatiLe Impurities by Head Space GC Technique</li>
                            <li>Potentiometric Titrations</li>
                            <li>Moisture Content by KarL Fischer Titrator</li>
                            <li>MeLting Range</li>
                        </ul>
                    </div>
                    <div class="col-lg-12 col-md-12 box wow bounceInUp" data-wow-duration="1.4s">
                        ...
                        <ul>
                            <li>Molecular weight estimation by Size Exclusion Chromatography</li>
                            <li>Pharmacopoeial Methods Evaluation</li>
                        </ul>
                    </div>
            ...
            <section id="I-list">
                <div class="container">
                    ...
                    <header class="section-header wow fadeInUp">
                        ...
                        <p>We have sophisticated equipments with cGMP Compliance. Our well experienced scientists and equipments support to carryout all testing activities.</p>
                    </header>
                    ...
                    <div class="row section-body">
                        ...
                        <div class="col-lg-12 col-md-12 box wow bounceInUp" data-wow-duration="1.4s">
                            <ul>
                                <li>HPLC Waters 2695 with 2996,2487</li>
                                <li>HPLC Agilent 1200 series</li>
                                <li>HPLC Agilent 1100 series</li>
                                <li>LC\MS Agilent</li>
                                <li>GC Agilent 6890N With Head space</li>
                                <li>GC\MS Perkin elmer with Auto sampler and Head space</li>
                                <li>Ion Chropmatograph</li>
                                <li>Atomic Absorption Spectrophotometer</li>
                                <li>Polarimeter, make : Perkin elmer</li>
                                <li>Karl fischer titrator, make: metrohm</li>
                                <li>Auto titrator , make : metrohm</li>
                                <li>Uy-VIS Spectrophotometer</li>
                                <li>IR Spectrophotometer</li>
                                <li>Analytical Balance make : Denwer</li>
                                <li>Analytical Balance make : Sartorius</li>
                                <li>pH Meter</li>
                                <li>Hot air Oven</li>
                                <li>Sonicator</li>
                                <li>Hot plate with magnetic stirror</li>
                                <li>Mill Q Water System : Thermo Scientific Fortune Pharma I-abs</li>
                                <li>Centrifuge</li>
                            </ul>
                        </div>
